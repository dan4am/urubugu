...
def animate_slider(clock):
    ...
    if vs_computer:
        ...
        while (destination < 21):
            ...
            screen.blit(pygame.transform.smoothscale(get_image(circle_activated_path), (30, 30)),
                        (395 - destination, 30))
...
def draw_slots():
    ...
    for line in range(len(board.BOARD)):
        for row in range(len(board.BOARD[0])):
            ...
            pygame.draw.circle(screen, WHITE, board_coordinates_to_screen_coordinates(line, row), SLOTS - 2,
                               1)  # à revoir
            ...
            if (design == "design_2/"):
                ...
                if (x >= start_button[0] and x <= start_button[0] + 350 and y >= start_button[1] and y <= start_button[
                    ...
                    draw_menu(lang=1)
                      ...
                      help_button[1] + 69):
                    draw_menu(help=1)
                elif (x >= vs_computer_button[0] and x <= vs_computer_button[0] + 350 and y >= vs_computer_button[
                    1] and y <=
                      vs_computer_button[1] + 69):
                    draw_menu(vs_cpu=1)
                else:
                    ...
                    if (not data[0] == 0):
                        ...
                        if (clicked_button == 1):
                            ...
                            while not event.type == pygame.MOUSEBUTTONUP:
                                ...
                                for event in pygame.event.get():
                                    if event.type == pygame.QUIT:
                                        ...
                                        tmp_pos = pygame.mouse.get_pos()
                                        if (tmp_pos[0] >= gukenyura_button[0] and tmp_pos[0] <= gukenyura_button[
                                            0] + 350 and
                                                tmp_pos[1] >= gukenyura_button[1] and tmp_pos[1] <= gukenyura_button[
                                                    1] + 69):
                                            change_state(3)
                                            board.player(1)
                                            draw_gukenyura_buttons()
                            ...
                            while not event.type == pygame.MOUSEBUTTONUP:
                                ...
                                for event in pygame.event.get():
                                    if event.type == pygame.QUIT:
                                        ...
                                        tmp_pos = pygame.mouse.get_pos()
                                        if (tmp_pos[0] >= language_button[0] and tmp_pos[0] <= language_button[0] + 74
                                                and tmp_pos[1] >= language_button[1] and tmp_pos[1] <= language_button[
                                                    1] + 35):
                                            ...
                                            while (not temp_done):
                                                ...
                                                # print( pos )
                                                if ((pos[0] >= 50 and pos[0] < 125) and (
                                                        pos[1] >= 66 and pos[1] < 101)):
                                                    # draw_menu(lang=2)
                                                    if (design == "design_2/"):
                                                        screen.blit(
                                                            pygame.transform.smoothscale(get_image(selection_flag_path),
                                                                                         (69, 32)), (53, 65))
                                                        screen.blit(pygame.transform.smoothscale(
                                                ...
                                                elif ((pos[0] >= 50 and pos[0] < 125) and (
                                                        pos[1] >= 102 and pos[1] < 137)):
                                                    # draw_menu(lang=2)
                            ...
                            while not event.type == pygame.MOUSEBUTTONUP:
                                screen.fill(WHITE)
                                tmp_pos = pygame.mouse.get_pos()
                                if (tmp_pos[0] >= vs_computer_button[0] and tmp_pos[0] <= vs_computer_button[
                                    0] + 350 and
                                        tmp_pos[1] >= vs_computer_button[1] and tmp_pos[1] <= vs_computer_button[
                                            1] + 69):
                                    draw_menu(vs_cpu=1)
                                else:
                                    draw_menu()
                                ...
                                for event in pygame.event.get():
                                    if event.type == pygame.QUIT:
                                        ...
                                        if (tmp_pos[0] >= vs_computer_button[0] and tmp_pos[0] <= vs_computer_button[
                                            0] + 350 and
                                                tmp_pos[1] >= vs_computer_button[1] and tmp_pos[1] <=
                                                vs_computer_button[1] + 69):
                                            vs_computer = True
                                            board.choose_board(board.BOARD_DEFAULT)
                                            change_state(1)
                                        ...
                                        if event.type == pygame.QUIT:
                                            ...
                                            if event.button == 1:
                                                if (clicked == False):
                                                    ...
                                                    position = pygame.mouse.get_pos()
                                                    data = game_coordinates_to_data(position[0], int(position[1]))
                                                    if (data[1] >= 1 and data[
                                                        1] <= 16):  ##if the player clicks outside the buttons to chose the number of beads
                                                        if (not ((position[0] >= tmp_position[0] and position[0] <=
                                                                  tmp_position[
                                                                      0] + 85) and (
                                                                         position[1] > tmp_position[1] and position[
                                                                     1] <= tmp_position[1] + 175 + 13))):
                                                            clicked = True
                                                            tmp_position[0] = position[0]
                                                            tmp_position[1] = position[1]
                                                            print(position)
                                                            ...
                                                            clicked = False
                                                            number_of_beads = 0
                                                            temp = position[1] - tmp_position[
                                                                1]  # temp helps us to retrieve how many beads the palyer clicked on based on the y axis
                                                            ...
                                                            print(position)
                                                            data = game_coordinates_to_data(position[0],
                                                                                            int(position[1]))
                                                            print(data)
